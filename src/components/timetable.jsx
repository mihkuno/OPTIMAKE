...
export default function Timetable({ scheduleData, COURSE_NAMES, ROOM_NAMES, SECTION_NAMES }) {
  ...
  const renderScheduleItem = (item) => {
    ...
    return (
      <div
        key={`${item.course}-${item.day}-${item.start_time}-${item.end_time}-${item.room}-${item.section}`}
